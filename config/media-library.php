...
return [
     ...
     */
    /*
     * Private, not public. A channel can be private, and a public disk hands
     * out a URL that works for anybody who has it — which would put an
     * attachment from a private channel one forwarded link away from everyone.
     * Attachments are served through a route that asks the ChannelPolicy first.
     */
     ...
     */
    /*
     * Named as a string: the class ships with Media Library Pro, which this
     * project does not have. ::class would be a reference to something that is
     * not there, and only the pro package ever reads this key.
     */
