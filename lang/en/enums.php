...
return [
    ...
    'workspace-ability' => [
        'label' => [
            ...
            'ImpersonateMembers' => 'Sign in as another member',
        ...
        'description' => [
            ...
            'ManageMembers' => 'Open the member list, give somebody a different role, decide which channels a guest sits in, and remove people from the workspace. Removing somebody takes them out of all their channels at once; what they wrote stays. Inviting is a separate matter. You can never reach somebody whose role stands above your own.',
            'ImpersonateMembers' => 'Look at the workspace as somebody else, to see what they see. While that runs you are them: you read their private channels and their DMs, and anything you write is under their name with nothing to tell it apart. They are not notified. You can never step into a role that stands above your own, and their password, two-factor, passkeys and API tokens stay shut.',
