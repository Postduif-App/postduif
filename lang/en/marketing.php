...
return [
    ...
    'home' => [
        ...
        'roles' => [
            ...
            'lead' => 'A guest is somebody from outside: a customer, a supplier. They see only the channels they were invited to.',
            'role' => 'Role',
            'manage' => 'Manage',
            'invite' => 'Invite',
            ...
            'note' => 'This table comes from the same code that enforces the rules. Change the rule and the table changes.',
            'yes' => 'yes',
            'no' => 'no',
        ],
    ],
