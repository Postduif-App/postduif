...
return [
    ...
    'view' => [
        ...
        'confirm_title' => 'Dit document verwijderen?',
        'confirm' => ':title verdwijnt voor iedereen in het kanaal. Er staat nergens een kopie.',
        'cancel' => 'Annuleren',
        'reload' => 'Herladen',
    ...
    'history' => [
        'label' => 'Eerdere versies',
        'title' => 'Eerdere versies',
        'description' => 'Wat dit document zei voordat iemand het veranderde. Terugzetten gooit niets weg — wat er nu staat komt er als versie bij.',
        'loading' => 'Bezig met ophalen…',
        'failed' => 'De versies konden niet opgehaald worden.',
        'empty' => 'Dit document is nog niet herschreven.',
        'somebody' => 'Iemand',
        'restore' => 'Terugzetten',
    ],
    'code' => [
        'language' => 'Taal van dit codeblok',
        'plain' => 'Zonder kleuren',
    ],
    'block' => [
        'label' => 'Dit blok',
    ...
    'table' => [
        'header_row' => 'Kopregel',
        'header_column' => 'Kopkolom',
        'row_after' => 'Rij eronder',
        'column_after' => 'Kolom ernaast',
        'row_delete' => 'Rij verwijderen',
        'column_delete' => 'Kolom verwijderen',
    ],
    'editor' => [
