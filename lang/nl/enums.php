...
return [
    ...
    'workspace-ability' => [
        'label' => [
            ...
            'ImpersonateMembers' => 'Inloggen als een ander lid',
        ...
        'description' => [
            ...
            'ManageMembers' => 'De ledenlijst openen, iemand een andere rol geven, bepalen in welke kanalen een gast zit en mensen uit de workspace verwijderen. Verwijderen haalt iemand meteen uit al zijn kanalen; wat diegene geschreven heeft blijft staan. Uitnodigen staat hier los van. Je kunt nooit bij iemand met een rol boven de jouwe.',
            'ImpersonateMembers' => 'De workspace bekijken als iemand anders, om te zien wat diegene ziet. Zolang dat loopt ben je die persoon: je leest zijn privékanalen en zijn DM\'s, en alles wat je schrijft staat op zijn naam zonder dat iemand het verschil ziet. Diegene krijgt er geen melding van. Je kunt nooit bij iemand met een rol boven de jouwe, en wachtwoord, tweestapsverificatie, passkeys en API-tokens blijven dicht.',
