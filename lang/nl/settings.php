...
return [
    ...
    'notifications' => [
        ...
        'push' => 'Browsermeldingen',
        'push_hint' => 'Een melding op dit apparaat, ook als Postduif niet openstaat.',
        'push_missing' => 'Niet ingesteld op deze installatie.',
        'push_unsupported' => 'Deze browser kan geen meldingen ontvangen.',
        'push_checking' => 'Even kijken wat deze browser al weet…',
        'push_allow' => 'Meldingen toestaan',
        'push_allow_hint' => 'Je browser vraagt het je één keer.',
        'push_on' => 'Deze browser ontvangt meldingen.',
        'push_off' => 'Uitzetten op deze browser',
        'push_denied' => 'Je hebt meldingen geblokkeerd voor Postduif. Dat kunnen wij niet terugdraaien: zet het weer aan bij de site-instellingen van je browser, naast de adresbalk.',
        'push_failed' => 'Aanzetten lukte niet. Probeer het nog eens.',
        'push_no_key' => 'Deze installatie heeft geen sleutel voor browsermeldingen.',
        'devices' => 'Apparaten die meeluisteren',
        'devices_empty' => 'Nog geen apparaten.',
        'device_on' => ':browser op :platform',
        'device_unknown' => 'Onbekend apparaat',
        'device_last_used' => 'Laatst bereikt :moment',
        'device_never_used' => 'Nog niets naartoe gestuurd',
        'device_remove' => 'Verwijderen',
        'test_send' => 'Testmelding sturen',
        'test_delivered' => '{1}Onderweg naar dit apparaat.|[2,*]Onderweg naar :count apparaten.',
        'test_refused' => 'Geen enkel apparaat nam de melding aan. Meestal is de toestemming ingetrokken of het abonnement verlopen — zet meldingen op deze browser uit en weer aan.',
        'test_nobody' => 'Nog geen apparaat om naartoe te sturen.',
        'test_error' => 'Versturen lukte niet. Probeer het nog eens.',
    ],
